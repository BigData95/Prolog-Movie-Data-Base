...
hazOpcion(1) :-
    ...
    writeln(B),
    write('actores: '),
    findall(A, actor(Pelicula, A, _), L2),
    write(L2),
    nl,
    write('actrices: '),
    findall(A, actress(Pelicula, A, _), L3),
    write(L3),
    nl,
    nl,
    menu.
...
hazOpcion(5) :-
    ...
    switch(Info,
           ...
           [ 1:(writeln('Dame el nombre del actor, en minusculas'), read(Actor), retract(actor(Pelicula, Actor, _))),
